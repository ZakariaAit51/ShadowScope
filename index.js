...
const browser = await puppeteer.launch({
    ...
    try {
        ...
        //     // Block downloads that match the download URL pattern
        //     if (url.includes('expires')) {
        //         console.log('Blocking download download:', url);
        //         download.abort(); // Abort the download download
        //     } else {
        //         download.continue(); // Continue with other downloads
        //     }
        // });
...
const browser = await puppeteer.launch({
    ...
    try {
        ...
        // Save to file
        fs.writeFileSync('download_links.json', JSON.stringify(downloadLinks, null, 2));
